        ...
        <div>
          <div className="md:mt-8">
            <div className="mx-auto w-full  ">
              <div className="grid grid-cols-2 md:gap-5  pt-6 lg:pt-8 md:grid-cols-4 px-3">
                {/* -------- col-1 ---------- */}
                <div
              ...
              <div className="flex flex-col px-4 mt-4">
                ...
                {/* -------- col-1 ---------- */}
                <div
                  className="md:hidden flex mx-auto  items-center justify-center mt-3"
                  style={{
                    zIndex: "10",
                  }}
                >
                  <div className="">
                    ...
                    <span className="flex gap-3 text-[30px] justify-center items-center py-3 mt-2">
                      <FaFacebook className="text-blue-700" />
                      <FaYoutube className="text-red-700 " />
                      <FaInstagram className="text-pink-700" />
                    </span>
