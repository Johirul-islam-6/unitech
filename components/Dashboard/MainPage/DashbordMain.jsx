      ...
      <div className="main-page-dashboard ">
        <div className="over-view w-[100%] h-[auto] bg-[#F4F4F4] p-2 py-4 rounded-md">
          <div className=" flex justify-between">
            <h1 className="text-[18px] font-[700] text-[#393A3A]">Overview</h1>
            {/* ----drop down--- */}
            <input
              class="dark-light"
              type="checkbox"
          ...
          <div className="all-box grid grid-cols-2 gap-5  md:grid-cols-5  md:justify-start justify-center items-center mt-3">
            {/* ----box -01 ---- */}
            <div className="Impressions bg-[#72bce7] px-4 py-6 rounded-lg dashbord-box-shadow ">
              <p className="text-[18px] font-[700]">Impressions</p>
              <div className="flex items-center ">
                <h1 className="total-count-number text-[30px] md:text-[40px]">
                  79.1k
                </h1>
            ...
            <div className="Visitors bg-[#d7d7d7] px-4 py-6 rounded-lg dashbord-box-shadow ">
              <p className="text-[18px] font-[700]">Visitors</p>
              <div className="flex items-center ">
                <h1 className="total-count-number text-[30px] md:text-[40px]">
                  79.1k
                </h1>
            ...
            <div className="Engaged bg-[#fef4e9] px-4 py-6 rounded-lg dashbord-box-shadow ">
              <p className="text-[18px] font-[700]">Engaged</p>
              <div className="flex items-center ">
                <h1 className="total-count-number text-[30px] md:text-[40px]">
                  15k
                </h1>
            ...
            {/* ----box -05 ---- */}
            <div className="Enrolled bg-[#72bce7] px-4 py-6 rounded-lg dashbord-box-shadow ">
              <p className="text-[18px] font-[700]">Enrolled</p>
              <div className="flex items-center ">
                <h1 className="total-count-number text-[30px] md:text-[40px]">
                  90.2k
                </h1>
            ...
            <div className="Total Users bg-[#d7d7d7] px-4 py-6 rounded-lg dashbord-box-shadow ">
              <p className="text-[18px] font-[700]">Total Users</p>
              <div className="flex items-center ">
                <h1 className="total-count-number text-[30px] md:text-[40px]">
                  22.2k
                </h1>
        ...
        <div className="all-course-card mt-10">
          <div className="flex justify-between items-center ">
            <h1 className="text-[18px] font-[700] text-[#393A3A]">
              Academic Courses
            </h1>
            <button className="border-2 flex items-center gap-1 px-3 py-2 bg-[#00000004] text-[12px] font-[700] text-[#707070] rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="24"
          ...
          <div className="flex flex-wrap md:grid gap-y-8 md:gap-3   md:grid-cols-2 lg:grid-cols-4  justify-center items-center mt-8">
            <AllCard />
            <AllCard />
            <AllCard />
            <AllCard />
