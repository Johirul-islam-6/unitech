      ...
      <div className="main-page-dashboard  relative z-10 ">
        ...
        <div className="all-course-card mt-10">
          ...
          <div className="diploma_Academic mt-10">
            ...
            {Loading ? (
              <>
                <div className="h-[40vh] flex justify-center items-center w-[100%] ">
                  <div className="flex  gap-3 pb-2">
                    <div className="rounded-full h-[8px] w-[8px] bg-violet-800 animate-ping"></div>
                    <div className="rounded-full h-[8px] w-[8px] bg-violet-800 animate-ping"></div>
                    <div className="rounded-full h-[8px] w-[8px] bg-violet-800 animate-ping"></div>
                  </div>
                </div>
          ...
          <div className="Skill-Development mt-16">
            ...
            {Loading ? (
              <>
                <div className="h-[60vh] flex justify-center items-center w-[100%] ">
                  <div className="flex  gap-3 pb-2">
                    <div className="rounded-full h-[8px] w-[8px] bg-violet-800 animate-ping"></div>
                    <div className="rounded-full h-[8px] w-[8px] bg-violet-800 animate-ping"></div>
                    <div className="rounded-full h-[8px] w-[8px] bg-violet-800 animate-ping"></div>
