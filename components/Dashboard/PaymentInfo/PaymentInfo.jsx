      ...
      <div className="mt-2 p-2">
        ...
        <div className=" flex gap-5 justify-between items-center">
          <div className=" flex justify-between gap-2 items-center ">
            ...
            <div className="flex gap-2 items-center ">
              ...
              <div class="relative  rounded-md shadow-sm ">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center "></div>

                <div class="absolute inset-y-0 left-0 flex items-center  w-[100px]">
                  <label for="currency" class="sr-only"></label>
                  <select
                    id="currency"
                    name="currency"
                    class="h-full rounded-md flex bg-transparent py-4 w-[100px] text-start border-2  text-gray-500 2 sm:text-sm"
                  >
                    {" "}
                    <option>All </option>
                    <option>two </option>
            ...
            <div className="flex gap-2 items-center">
              ...
              <div class="relative  rounded-md shadow-sm ">
                ...
                <div class="absolute inset-y-0 left-0 flex items-center  w-[120px]">
                  <label for="currency" class="sr-only"></label>
                  <select
                    id="currency"
                    name="currency"
                    class="h-full rounded-md flex bg-transparent py-4 w-[120px] text-start border-2  text-gray-500 2 sm:text-sm"
                  >
                    {" "}
                    <option>1st Semenster </option>
                    <option>1st Semenster </option>
                    <option>1st Semenster </option>
                    <option>1st Semenster </option>
                    <option>1st Semenster </option>
          ...
          <div className="flex items-center gap-2 cursor-pointer ">
            <h1 className="text-[#0984E3] font-[700] hidden lg:flex whitespace-nowrap">
        ...
        <div className="mt-8">
          <section class="py-1 flex md:flex-row flex-col justify-center md:justify-between gap-2">
            ...
            {/* ---- searching button ---- */}
            <div className=" px-3 py-1 bg-[#FFF] box-shdow-5 h-[atuo]  rounded-lg ">
              ...
              <div className="mt-2">
                ...
                <div class="relative mt-2 rounded-md shadow-sm ">
                  ...
                  <div class="absolute inset-y-0 left-0 flex items-center w-[100%] ">
                    <label for="currency" class="sr-only"></label>
                    <select
                      id="currency"
                      name="currency"
                      class="h-full rounded-md flex bg-transparent py-5 border-2 w-[100%] pe-2 pl-2 text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm"
                    >
                      {" "}
