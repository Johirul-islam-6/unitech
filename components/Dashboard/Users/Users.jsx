      ...
      <div className="User-page  p-2">
        ...
        <div className="mt-5 md:mt-5">
          <section className="py-1 flex md:flex-row flex-col justify-center md:justify-between gap-2">
            ...
            {/* ---- searching button ---- */}
            <div className=" px-3 py-4 bg-[#FFF] box-shdow-5 h-[220px] rounded-lg ">
              <h1 className="text-[18px] font-[700] pb-3 text-center">
                Filter Search
              </h1>
              ...
              <button className="py-[10px] px-2 bg-[#F89521] w-full flex text-center rounded-md justify-center font-[700] text-[16px] mt-4 text-[#212121]">
                Search
              </button>
            </div>
          </section>
