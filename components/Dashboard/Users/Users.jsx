      ...
      <div className="User-page  p-2">
        ...
        <div className=" flex gap-5 justify-between items-center">
            ...
            <div className="flex gap-1 items-center">
              ...
              <div class="menu-dropdown sec-center whitespace-nowrap  pe-10 ps-2">
                ...
                <div class="section-dropdown px-5">
                  ...
                  <a className="overView-a" href="#">
                    Graphic Design <i class="uil uil-arrow-right"></i>
                  </a>

                  <a className="overView-a" href="#">
                    UX/UI Designer <i class="uil uil-arrow-right"></i>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center gap-2 cursor-pointer ">
            <h1 className="text-[#0984E3] font-[700] hidden lg:flex">
        ...
        <div className="mt-8">
          <section class="py-1 flex md:flex-row flex-col justify-center md:justify-between gap-2">
            ...
            {/* ---- searching button ---- */}
            <div className=" px-3 py-4 bg-[#FFF] box-shdow-5 h-[350px] rounded-lg ">
              <h1 className="text-[18px] font-[700] py-3">Filter Search</h1>
              <div>
                <label
                  for="name"
              ...
              <button className="py-2 border-2 px-2 bg-[#f8942100] w-full flex gap-1 text-center rounded-md justify-center text-[16px] font-[700] mt-2 items-center text-[#212121]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
